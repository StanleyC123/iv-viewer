...
class FullScreenViewer extends ImageViewer {
    ...
    show(imageSrc, hiResImageSrc, viewBox, paths, fill, stroke) {
        // show the element
        ...
        if (imageSrc) {
            ...
            this._events.onHomeBtnClick = assignEvent(homeBtn, 'click', () => { this.load(imageSrc, hiResImageSrc, viewBox, paths, fill, stroke) });
