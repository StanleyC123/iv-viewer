...
function () {
  function ImageViewer(element) {
    ...
    _defineProperty(this, "applyMatrix", function (matrixA) {
      ...
      var matrixB = (0, _matrix.m2dParseTransformString)(curTransform.match(/matrix[(].*?[)]/g)[0]);
      var matrixC = (0, _matrix.m2dParseTransformString)(curTransform.match(/matrix[(].*?[)]/g)[1]);
      var matrixBC = (0, _matrix.m2dMultiply)(matrixB, matrixC);
      var curMatrix = (0, _matrix.m2dParseTransformString)((0, _util.css)(_this._elements.image, 'transform')); // Re-apply transformation instantaneously

      (0, _util.css)(_this._elements.image, {
        transform: (0, _matrix.m2dToTransformString)(matrixBC),
        transition: "none"
      }); // Apply new transformation with transition

      setTimeout(function () {
        return (0, _util.css)(_this._elements.image, {
          transform: (0, _matrix.m2dToTransformString)(matrixA) + (0, _matrix.m2dToTransformString)(matrixBC),
    ...
    _defineProperty(this, "rotate", function (angle) {
      _this.applyMatrix((0, _matrix.m2dRotate)(angle));
    });

    _defineProperty(this, "reflect", function (angle) {
      _this.applyMatrix((0, _matrix.m2dReflect)(angle));
    });
      ...
      for (var i in paths) {
        if (imageSrc == paths[i].href || hiResImageSrc == paths[i].href) {
          for (var j in paths[i].children) {
            ...
            var path = (0, _util.createElement)({
              tagName: 'path',
      ...
      var _loop = function _loop(_i) {
        var _loop2 = function _loop2(_j) {
          if (paths[_j].href == pathArr[_i].href) {
            (0, _util.assignEvent)(pathArr[_i].elem, 'click', function (e) {
              e.stopPropagation();
      ...
      var _loop3 = function _loop3(_i2) {
        var _loop4 = function _loop4(_j2) {
          if (paths[_j2].href == pathArr[_i2].href) {
            // assignEvent(pathArr[i].elem, 'touchstart', function (e) { console.log(e); e.preventDefault(); onPathClicked(pathArr[i].href, paths[j].viewBox) });
            (0, _util.assignEvent)(pathArr[_i2].elem, 'click', function (e) {
              console.log(e);
              e.stopPropagation();
