...
function () {
  function ImageViewer(element) {
    ...
    _defineProperty(this, "applyMatrix", function (matrixA) {
      ...
      var curMatrix = (0, _matrix.m2dParseTransformString)((0, _util.css)(_this._elements.image, 'transform'));
      console.log(curTransform);
      console.log((0, _matrix.m2dToTransformString)(matrixBC)); // Re-apply transformation instantaneously
      ...
      var _loop = function _loop(_i) {
        var _loop2 = function _loop2(_j) {
          if (paths[_j].href == pathArr[_i].href) {
            (0, _util.assignEvent)(pathArr[_i].elem, 'click', function () {
      ...
      var _loop3 = function _loop3(_i2) {
        var _loop4 = function _loop4(_j2) {
          if (paths[_j2].href == pathArr[_i2].href) {
            (0, _util.assignEvent)(pathArr[_i2].elem, 'click', function () {
