...
function (_ImageViewer) {
  ...
  function FullScreenViewer() {
    ...
    var _fullScreenElem = (0, _util.createElement)({
      tagName: 'div',
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(FullScreenViewer).call(this, _container, _objectSpread({}, options, {
    ...
    _defineProperty(_assertThisInitialized(_this), "hide", function () {
      ...
      (0, _util.remove)(container.querySelectorAll('.iv-snap-image, .iv-image')); // enable scroll
